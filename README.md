...
<body>
    ...
    <script>
        ...
        const wineQuestions = [
            {
                wine: 'Merlot',
                question: 'What type of wine is Merlot?',
                correct: 'Red Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Sparkling Wine']
            },
            {
                wine: 'Chardonnay',
                question: 'What type of wine is Chardonnay?',
                correct: 'White Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Sparkling Wine']
            },
            {
                wine: 'Cabernet Sauvignon',
                question: 'What type of wine is Cabernet Sauvignon?',
                correct: 'Red Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Dessert Wine']
            },
            {
                wine: 'Sauvignon Blanc',
                question: 'What type of wine is Sauvignon Blanc?',
                correct: 'White Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Port Wine']
            },
            {
                wine: 'Pinot Noir',
                question: 'What type of wine is Pinot Noir?',
                correct: 'Red Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Sherry']
            },
            {
                wine: 'Riesling',
                question: 'What type of wine is Riesling?',
                correct: 'White Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Port Wine']
            },
            {
                wine: 'Malbec',
                question: 'What type of wine is Malbec?',
                correct: 'Red Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Sparkling Wine']
            },
            {
                ...
                correct: 'Sparkling Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Sparkling Wine']
            },
            {
                wine: 'Rosé',
                question: 'What type of wine is Rosé?',
                correct: 'Rosé Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Sparkling Wine']
            },
            {
                wine: 'Syrah',
                question: 'What type of wine is Syrah?',
                correct: 'Red Wine',
                options: ['Red Wine', 'White Wine', 'Rosé Wine', 'Dessert Wine']
            }
        ];
        ...
        function drawPlayer() {
            ...
            // Chick body (pixel art style)
            ctx.fillStyle = '#FFD700';
            ctx.fillRect(screenX + 10, player.y + 10, 20, 20);
            
            // Chick eyes
            ctx.fillStyle = '#000';
            const eyeOffset = player.direction > 0 ? 5 : -5;
            ctx.fillRect(screenX + 15 + eyeOffset, player.y + 15, 3, 3);
            
            // Chick beak
            ctx.fillStyle = '#FF8C00';
            if (player.direction > 0) {
                ctx.fillRect(screenX + 30, player.y + 18, 5, 4);
            } else {
                ctx.fillRect(screenX + 5, player.y + 18, 5, 4);
            }
            
            // Chick feet
            ctx.fillStyle = '#FF8C00';
            ctx.fillRect(screenX + 12, player.y + 30, 4, 6);
            ctx.fillRect(screenX + 24, player.y + 30, 4, 6);
        }
        ...
        function drawPlatforms() {
            platforms.forEach(platform => {
                ...
                for (let i = 0; i < platform.width; i += 20) {
                    ctx.fillRect(screenX + i, platform.y, 8, 10);
                }
            });
        }
        ...
        function drawWineTable(table) {
            ...
            // Table (wooden)
            ctx.fillStyle = '#8B4513';
            ctx.fillRect(screenX + 10, table.y + 40, 60, 8);
            
            // Table legs
            ctx.fillRect(screenX + 15, table.y + 48, 8, 25);
            ctx.fillRect(screenX + 57, table.y + 48, 8, 25);
            
            // Wine glass
            ctx.fillStyle = '#8B0000';
            ctx.fillRect(screenX + 30, table.y + 25 + bounce, 20, 15);
            ctx.fillStyle = '#654321';
            ctx.fillRect(screenX + 37, table.y + 40 + bounce, 6, 8);
            
            // Sparkle
            ctx.fillStyle = 'rgba(255, 255, 255, 0.8)';
            ctx.fillRect(screenX + 32, table.y + 28 + bounce, 3, 3);
        ...
        function drawBackground() {
            // Sky gradient already set in canvas style
            ...
            for (let i = 0; i < 5; i++) {
                ...
                ctx.fillRect(x + 10, y - 8, 30, 15);
                ctx.fillRect(x + 20, y, 30, 15);
            }
            ...
            for (let i = -2; i < 15; i++) {
                ...
                if (x > -50 && x < canvas.width + 50) {
                    ctx.fillRect(x, canvas.height - 200, 8, 140);
                    
                    // Vines
                    ctx.fillStyle = '#228B22';
                    ctx.fillRect(x - 30, canvas.height - 150, 70, 4);
                    ctx.fillRect(x - 20, canvas.height - 170, 4, 20);
                    ctx.fillRect(x + 10, canvas.height - 165, 4, 15);
                    ctx.fillRect(x + 30, canvas.height - 160, 4, 10);
                }
            }
            ctx.fillStyle = '#654321';
        }
        ...
        function updatePlayer() {
            ...
            wineTables.forEach(table => {
                if (!table.collected &&
                    Math.abs(player.x - table.x) < 60 &&
                    Math.abs(player.y - table.y) < 60) {
                    showQuestion(table);
                }
            });
        }
